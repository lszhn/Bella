...
;!function(t){"object"==typeof module&&"object"==typeof module.exports?t(require("jquery")):"function"==typeof define&&define.amd?define([],t(window.jQuery)):t(window.jQuery)}(function(t){if(!t)return console.warn("Unslider needs jQuery");t.Unslider=function(n,e){var i=this;return i._="unslider",i.defaults={autoplay:!1,delay:3e3,speed:750,easing:"swing",keys:{prev:37,next:39},nav:!0,arrows:{prev:'<a class="'+i._+'-arrow prev">Prev</a>',next:'<a class="'+i._+'-arrow next">Next</a>'},animation:"horizontal",selectors:{container:"ul:first",slides:"li"},animateHeight:!1,activeClass:i._+"-active",swipe:!0,swipeThreshold:.2},i.$context=n,i.options={},i.$parent=null,i.$container=null,i.$slides=null,i.$nav=null,i.$arrows=[],i.total=0,i.current=0,i.prefix=i._+"-",i.eventSuffix="."+i.prefix+~~(2e3*Math.random()),i.interval=[],i.init=function(n){return i.options=t.extend({},i.defaults,n),i.$container=i.$context.find(i.options.selectors.container).addClass(i.prefix+"wrap"),i.$slides=i.$container.children(i.options.selectors.slides),i.setup(),t.each(["nav","arrows","keys","infinite"],function(n,e){i.options[e]&&i["init"+t._ucfirst(e)]()}),jQuery.event.special.swipe&&i.options.swipe&&i.initSwipe(),i.options.autoplay&&i.start(),i.calculateSlides(),i.$context.trigger(i._+".ready"),i.animate(i.options.index||i.current,"init")},i.setup=function(){i.$context.addClass(i.prefix+i.options.animation).wrap('<div class="'+i._+'" />'),i.$parent=i.$context.parent("."+i._),"static"===i.$context.css("position")&&i.$context.css("position","relative"),i.$context.css("overflow","hidden")},i.calculateSlides=function(){if(i.$slides=i.$container.children(i.options.selectors.slides),i.total=i.$slides.length,"fade"!==i.options.animation){var t="width";"vertical"===i.options.animation&&(t="height"),i.$container.css(t,100*i.total+"%").addClass(i.prefix+"carousel"),i.$slides.css(t,100/i.total+"%")}},i.start=function(){return i.interval.push(setTimeout(function(){i.next()},i.options.delay)),i},i.stop=function(){for(var t;t=i.interval.pop();)clearTimeout(t);return i},i.initNav=function(){var n=t('<nav class="'+i.prefix+'nav"><ol /></nav>');i.$slides.each(function(e){var o=this.getAttribute("data-nav")||e+1;t.isFunction(i.options.nav)&&(o=i.options.nav.call(i.$slides.eq(e),e,o)),n.children("ol").append('<li data-slide="'+e+'">'+o+"</li>")}),i.$nav=n.insertAfter(i.$context),i.$nav.find("li").on("click"+i.eventSuffix,function(){var n=t(this).addClass(i.options.activeClass);n.siblings().removeClass(i.options.activeClass),i.animate(n.attr("data-slide"))})},i.initArrows=function(){!0===i.options.arrows&&(i.options.arrows=i.defaults.arrows),t.each(i.options.arrows,function(n,e){i.$arrows.push(t(e).insertAfter(i.$context).on("click"+i.eventSuffix,i[n]))})},i.initKeys=function(){!0===i.options.keys&&(i.options.keys=i.defaults.keys),t(document).on("keyup"+i.eventSuffix,function(n){t.each(i.options.keys,function(e,o){n.which===o&&t.isFunction(i[e])&&i[e].call(i)})})},i.initSwipe=function(){var t=i.$slides.width();"fade"!==i.options.animation&&i.$container.on({movestart:function(t){if(t.distX>t.distY&&t.distX<-t.distY||t.distX<t.distY&&t.distX>-t.distY)return!!t.preventDefault();i.$container.css("position","relative")},move:function(n){i.$container.css("left",-100*i.current+100*n.distX/t+"%")},moveend:function(n){Math.abs(n.distX)/t>i.options.swipeThreshold?i[n.distX<0?"next":"prev"]():i.$container.animate({left:-100*i.current+"%"},i.options.speed/2)}})},i.initInfinite=function(){var n=["first","last"];t.each(n,function(t,e){i.$slides.push.apply(i.$slides,i.$slides.filter(':not(".'+i._+'-clone")')[e]().clone().addClass(i._+"-clone")["insert"+(0===t?"After":"Before")](i.$slides[n[~~!t]]()))})},i.destroyArrows=function(){t.each(i.$arrows,function(t,n){n.remove()})},i.destroySwipe=function(){i.$container.off("movestart move moveend")},i.destroyKeys=function(){t(document).off("keyup"+i.eventSuffix)},i.setIndex=function(t){return t<0&&(t=i.total-1),i.current=Math.min(Math.max(0,t),i.total-1),i.options.nav&&i.$nav.find('[data-slide="'+i.current+'"]')._active(i.options.activeClass),i.$slides.eq(i.current)._active(i.options.activeClass),i},i.animate=function(n,e){if("first"===n&&(n=0),"last"===n&&(n=i.total),isNaN(n))return i;i.options.autoplay&&i.stop().start(),i.setIndex(n),i.$context.trigger(i._+".change",[n,i.$slides.eq(n)]);var o="animate"+t._ucfirst(i.options.animation);return t.isFunction(i[o])&&i[o](i.current,e),i},i.next=function(){var t=i.current+1;return t>=i.total&&(t=i.options.noloop&&!i.options.infinite?i.total-1:0),i.animate(t,"next")},i.prev=function(){var t=i.current-1;return t<0&&(t=i.options.noloop&&!i.options.infinite?0:i.total-1),i.animate(t,"prev")},i.animateHorizontal=function(t){var n="left";return"rtl"===i.$context.attr("dir")&&(n="right"),i.options.infinite&&i.$container.css("margin-"+n,"-100%"),i.slide(n,t)},i.animateVertical=function(t){return i.options.animateHeight=!0,i.options.infinite&&i.$container.css("margin-top",-i.$slides.outerHeight()),i.slide("top",t)},i.slide=function(t,n){if(i.animateHeight(n),i.options.infinite){var e;n===i.total-1&&(e=i.total-3,n=-1),n===i.total-2&&(e=0,n=i.total-2),"number"==typeof e&&(i.setIndex(e),i.$context.on(i._+".moved",function(){i.current===e&&i.$container.css(t,-100*e+"%").off(i._+".moved")}))}var o={};return o[t]=-100*n+"%",i._move(i.$container,o)},i.animateFade=function(t){i.animateHeight(t);var n=i.$slides.eq(t).addClass(i.options.activeClass);i._move(n.siblings().removeClass(i.options.activeClass),{opacity:0}),i._move(n,{opacity:1},!1)},i.animateHeight=function(t){i.options.animateHeight&&i._move(i.$context,{height:i.$slides.eq(t).outerHeight()},!1)},i._move=function(t,n,e,o){return!1!==e&&(e=function(){i.$context.trigger(i._+".moved")}),t._move(n,o||i.options.speed,i.options.easing,e)},i.init(e)},t.fn._active=function(t){return this.addClass(t).siblings().removeClass(t)},t._ucfirst=function(t){return(t+"").toLowerCase().replace(/^./,function(t){return t.toUpperCase()})},t.fn._move=function(){return this.stop(!0,!0),t.fn[t.fn.velocity?"velocity":"animate"].apply(this,arguments)},t.fn.unslider=function(n){return this.each(function(e,i){var o=t(i);if(!(t(i).data("unslider")instanceof t.Unslider)){if("string"==typeof n&&o.data("unslider")){n=n.split(":");var s=o.data("unslider")[n[0]];if(t.isFunction(s))return s.apply(o,n[1]?n[1].split(","):null)}return o.data("unslider",new t.Unslider(o,n))}})}});;function bellaRouter(){window.addEventListener("load",this.route.bind(this),!1),window.addEventListener("hashchange",this.route.bind(this),!1)}function hljs(){$("pre code").each(function(e,t){hljs.highlightBlock(t)})}function blClassGlbCov(){globalElements.forEach(function(e){var $eleList=$(e+":not(.alive)").toArray();$eleList.forEach(function(eleListMember){for(var funcName=e.replace(/-/,"")+"";funcName.indexOf("-")>0;)funcName=funcName.replace(/-/,"");funcName=funcName.replace(/./,"")+"Cov(eleListMember)",eval(funcName),console.log(funcName)})}),blStaticClassGlbCov()}function blStaticClassGlbCov(){globalStaticClasses.forEach(function(e){for(var funcName=e.replace(/-/,"")+"";funcName.indexOf("-")>0;)funcName=funcName.replace(/-/,"");funcName=funcName.replace(/./,"")+"Cov()",eval(funcName)})}function blviewCov(e){var t=$(e);t.toArray().forEach(function(e){var t=$(e).find(".bl-view-body"),a=t.toArray();a.forEach(function(e){$(e).css("display","none")}),$(a[0]).css("display","block")})}function blNotificationCov(e,t){var a=bella.getTimeStamp(),i=$('<div style="display: none" id="'+a+'" class="'+e+' raw-w"><div class="raw-f"><p></p></div><div onclick="bella.hideNotification()" class="tiny bl-notification-hide-button">Hide</div></div>');$("body").before(i),$("#"+a+" p").html(t),$("."+e).slideUp(300),$("#"+a).slideDown(300)}function bltabviewCov(e){var t=$(e),a=t.find(".bl-view-header li").toArray(),i=t.find(".bl-view-body").toArray(),n=parseFloat(t.find(".bl-view-header").css("width")),o=n/a.length;a.forEach(function(e){$(e).css({width:o})}),$(a[0]).addClass("bl-tab-view-active"),$(i[0]).css({display:"block"}),a.forEach(function(e){var n=$(e);n.on("click",function(){$(i).css({display:"none"}),$(i[a.indexOf(n.get(0))]).css({display:"block"}),t.find("li").removeClass("bl-tab-view-active"),n.addClass("bl-tab-view-active")})})}function switchtagCov(){var e=$(".switch-tag").toArray();e.forEach(function(e){var t=$(e).attr("name"),a=$("ul[name="+t+']:not(".switch-tag")').find(".bl-view-body"),i=$(e).find("a").toArray();i.forEach(function(e){$(e).on("click",function(){$(i).removeClass("bl-view-active"),$(e).addClass("bl-view-active"),$(a).css("display","none"),$(a[i.indexOf(e)]).css("display","block"),$(".m-bl-view-header").text($(e).text())})}),$(i[0]).addClass("bl-view-active")})}function attachtagCov(e){var t=$(e);$(document).scroll(function(){var e=$(document).scrollTop(),a=t.position().top;if(e>a&&0==$(".attach-tag-clone").length){var i=t.clone(!0);t.append(i),i.addClass("attach-tag-clone"),i.css({position:"fixed",top:t.position().top-parseFloat(t.css("height"))+"px",left:t.position().left+"px","z-index":500})}else a>=e&&$(document).find($(".attach-tag-clone")).remove()})}function blpageCov(e){var t=$(e),a=new showdown.Converter({omitExtraWLInCodeBlocks:!0,noHeaderId:!1,prefixHeaderId:"",ghCompatibleHeaderId:!0,headerLevelStart:1,parseImgDimensions:!0,simplifiedAutoLink:!0,excludeTrailingPunctuationFromURLs:!1,literalMidWordUnderscores:!0,strikethrough:!0,tables:!0,tablesHeaderId:!1,ghCodeBlocks:!0,tasklists:!0,smoothLivePreview:!0,smartIndentationFix:!1,disableForced4SpacesIndentedSublists:!1,simpleLineBreaks:!1,requireSpaceBeforeHeadingText:!1,ghMentions:!1,extensions:[],sanitize:!1}),i=t.find("p").toArray();i.forEach(function(e){var t=$(e);t.html(a.makeHtml(t.html()))})}function blsidebarCov(e){var t=$(e),a=t.children("a").toArray();t.children("a:first").addClass("bl-sidebar-active"),a.forEach(function(e){var a=$(e);a.on("click",function(){t.children("a").removeClass("bl-sidebar-active"),a.addClass("bl-sidebar-active")})})}function blnavCov(e){var t=$(e),a=t.children("li").toArray();a.forEach(function(e){var t=$(e),a=t.children("ul");a.before('<i class="fa fa-angle-down"></i>'),t.on("click",function(){a.hasClass("bl-nav-active")?a.fadeOut(100,function(){$(".bl-nav-active").css("display","none").removeClass("bl-nav-active")}):($(".bl-nav-active").css("display","none").removeClass("bl-nav-active"),a.addClass("bl-nav-active").css({top:t.position().top+"px"+t.css("height"),left:t.position().left+"px"}),a.fadeIn(100))}),a.mouseleave(function(){a.fadeOut(100,function(){$(".bl-nav-active").css("display","none").removeClass("bl-nav-active")})})}),t.addClass("alive")}var globalElements=[".bl-tab-view",".bl-nav",".bl-sidebar",".bl-page",".bl-view",".attach-tag"],globalStaticClasses=[".switch-tag"];$(document).ready(function(){blClassGlbCov()}),bella={version:"0.1",currHashRoute:"",getUrlHash:function(){console.log(location.hash)},mobileSupport:function(){$("title").after('<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no, target-densitydpi=device-dpi" />'),document.documentElement.addEventListener("touchstart",function(e){e.touches.length>1&&e.preventDefault()},!1);var e=0;document.documentElement.addEventListener("touchend",function(t){var a=Date.now();300>=a-e&&t.preventDefault(),e=a},!1)},getWindowHeight:function(){return $(window).height()},getTimeStamp:function(){return(new Date).getTime()},scrollToTop:function(){window.scrollBy(0,-10),scrolldelay=setTimeout("pageScroll()",100),0==document.documentElement.scrollTop&&clearTimeout(scrolldelay)},notify:function(e){blNotificationCov("bl-notification-normal",e)},alert:function(e){blNotificationCov("bl-notification-alert",e)},hideNotification:function(){$(".bl-notification-alert button").remove(),$(".bl-notification-normal button").remove(),$(".bl-notification-normal").slideUp(500,function(){$(".bl-notification-normal").remove()}),$(".bl-notification-alert").slideUp(500,function(){$(".bl-notification-alert").remove()})}},bellaRouter.prototype.route=function(){this.curHash=location.hash.slice(1)||"#",bella.currHashRoute=this.curHash,console.log(bella.currHashRoute),$.post("router.php",{routePath:bella.currHashRoute},function(e){$("#main").css("display","none").html(e).fadeIn(200),blClassGlbCov()})};var router=new bellaRouter;